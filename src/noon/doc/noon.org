...
The initial goal was to define musical fragments declaratively,
leveraging Clojure and functional programming to *generate, manipulate, and organize* musical content.
...
****** =upd=
As seen in the above examples, the =noon.harmony/upd= function turns a keyword describing a harmonic context into a usable score update.
****** =lin=
The =noon.harmony/lin= function is the same as the =noon.updates/lin= function, except it can understand harmonic keywords.
****** =tup=
The =noon.harmony/tup= function is the same as the =noon.updates/tup= function, except it can understand harmonic keywords.
****** implementation
