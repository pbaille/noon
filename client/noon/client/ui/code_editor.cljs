...
(def themes
  {:light {:cm-theme        cm-themes/quietlight
   ...
   :dark  {:cm-theme        cm-themes/materialDark
           :accent          "#56c8d8"
           :accent-bg       "rgba(86,200,216,0.15)"
           :accent-bg-half  "rgba(86,200,216,0.08)"
           :accent-border   "rgba(86,200,216,0.25)"
           :bg              "#2e3235"
           :bg-secondary    "#363a3d"
           :bg-overlay      "rgba(46,50,53,0.6)"
           :text-primary    "#bdbdbd"
           :text-secondary  "#707d8b"
           ...
           :highlight-bg    "#2e3235"
           :error-text      "rgba(255,95,82,0.7)"
           :error-bg        "rgba(255,95,82,0.08)"
           :error-border    "#ff5f52"
           :spinner-color   "#56c8d8"
           :toggle-active-bg "#3e4346"
           :badge-color     "#fa5788"}})
