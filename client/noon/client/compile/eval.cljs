(ns noon.client.compile.eval
  #_klangmeister.compile.eval
  (:require
   [cljs.js :as cljs])
  (:require-macros
   [noon.client.compile.macros :refer [sources literally]]))
...
#_(println dependencies)

(defn normalise [result]
  (println result)
  #_(println (update result :error #(some-> % .-cause .-message))))
