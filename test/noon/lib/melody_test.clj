...
(deftest main
  ...
  (testing "contour"
    (is (t/frozen (n/tup n/d0 n/d1 n/d2)
  ...
  (testing "gen"
    ...
    (is (t/frozen (m/simple-line 32 (n/one-of n/s1 n/s1- n/d1 n/d1-))
                  (n/adjust 4)))

    (is (t/frozen (m/simple-line 32 (n/one-of n/s1 n/s1- (n/tup n/d1 n/d0 n/s2-) (n/tup n/d1- n/d0 n/s2)))
                  (n/adjust 8)))
    ...
    (is (t/frozen {:description "another way to build a melodic line from a bunch of randomly chosen updates"}
