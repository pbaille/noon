...
(deftest main
  ...
  (testing "gen"
    ...
    (is (t/frozen (m/simple-line 32 (one-of s1 s1- d1 d1-))
                  (adjust 4)))

    (is (t/frozen (m/simple-line 32 (one-of s1 s1- (tup d1 d0 s2-) (tup d1- d0 s2)))
                  (adjust 8)))
