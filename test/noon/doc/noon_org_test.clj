  ...
  (t/testing "Noon"
    ...
    (t/testing "Composing"
      ...
      (t/testing "Rythmn"
        (t/testing "Simple"
          ...
          (t/is (noon.freeze/freeze (play (patch :woodblock)
                                          dur2
                                          (tup* (map dur
                                                  [1 1/2 1/2 1 2 1 1])))))
          (t/is (noon.freeze/freeze (play dur2 (r/durtup 1 1/2 1/2 1 2 1 1))))
          (t/is (noon.freeze/freeze (play dur2
                                          (r/durtup* [1 1/2 1/2 1 2 1 1])))))
    ...
    (t/testing "Experiments"
                  ...
                  (play harmonic-minor
                        ...
                        (randomly-interleaved
                          ...
                          [(chan 3) (nlin 4 (shuftup s0 s1 s2 s3)) s4
                           (each rand-double-passing)]))))))
          (t/testing "experience 1"
            (t/is (noon.freeze/freeze (play (rep 6 s1) (m/connect 1))))
            (t/is (noon.freeze/freeze (play o1 (rep 6 s1-) (m/connect 1))))
            (t/is (noon.freeze/freeze
                    (defn connect-with
                          ...
                          (let [from (first chunk1)
                            ...
                            (score/update-score
                              ...
                              [(lin _ [(ef_ (assoc _ :pitch (:pitch to))) f])
                               (adjust from)])))))))
            (t/is (noon.freeze/freeze (play (lin s0 s2 s4) (connect-with d1))))
            (t/is (noon.freeze/freeze (play (lin s0 s2 s4)
                                            (lin s0 s1 s2)
                                            (connect-with (tup d1- d1)))))
            (t/is (noon.freeze/freeze (play [aeolian dur:2]
                                            (lin s0 s2 s4)
                                            (lin s0 s1 s2)
                                            (connect-with (shuflin d1 c1-)))))
            (t/is (noon.freeze/freeze (play harmonic-minor
                                            (lin I VII)
                                            (nlin> 3 (transpose c3))
                                            (h/align-contexts :s)
                                            (dup 2)
                                            ...
                                            (connect-with d1))))
            (t/is (noon.freeze/freeze
                    (play [harmonic-minor (lin I VII) (nlin> 3 (transpose c3))
      ...
      (t/testing "Concepts and techniques"
        ...
        (t/testing "Simple counterpoint"
          (t/is (noon.freeze/freeze (require (quote [clojure.math.combinatorics
                                                     :as combinatorics]))))
          (t/is
            (noon.freeze/freeze
              (let [perms (combinatorics/permutations [0 1 2 3])
                ...
                (play (patch :electric-piano-1)
                      ...
                      [aeolian (lin _ (degree -1)) (lin _ s1)
                       (lin _ [(degree 3) s1-]) (lin _ (transpose c3-))]
                      ($by :channel
              ...
              (defn complementarity-tree
                ([structure-size sequence-size]
                 (let [elements (range structure-size)
                       ...
                       partials (filter (fn [s] (= r (count s)))
                                  (combinatorics/subsets elements))
                       permutations (mapcat (fn [p]
              ...
              (quote
                (let [[arpegios ornamentations harmonic-sequences articulations]
                      ...
                      choices {:harmony {0 _,
                               ...
                               :arpegio {0 s0, 1 s1, 2 s2},
                               :ornamentation
                                 {0 void, 1 (lin vel0 d1), 2 (lin d1- vel0)},
                               :instruments
                                 {0 [(vsl/instrument :chamber-violins-1) o1],
            ...
            (noon.freeze/freeze
              (play
                ...
                (append (superpose (k (nlin 4
                                      ...
                                      (dup 8)))))))))
      (t/testing "Usage"
        (t/testing "Vienna symphonic library"
          (t/is (noon.freeze/freeze
                  (vsl/noon
                    {:play true}
